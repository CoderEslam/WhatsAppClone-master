...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChatMessagesDb = FirebaseDatabase.getInstance("https://whatsappsimclone-master-default-rtdb.firebaseio.com").getReference().child("chat").child(mChatObject.getChatId()).child("messages");
