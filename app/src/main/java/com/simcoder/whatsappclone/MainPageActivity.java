...
public class MainPageActivity extends AppCompatActivity {
    ...
    private void getUserChatList(){
        DatabaseReference mUserChatDB = FirebaseDatabase.getInstance("https://whatsappsimclone-master-default-rtdb.firebaseio.com").getReference().child("user").child(FirebaseAuth.getInstance().getUid()).child("chat");
    ...
    private void getChatData(String chatId) {
        DatabaseReference mChatDB = FirebaseDatabase.getInstance("https://whatsappsimclone-master-default-rtdb.firebaseio.com").getReference().child("chat").child(chatId).child("info");
    ...
    private void getUserData(UserObject mUser) {
        DatabaseReference mUserDb = FirebaseDatabase.getInstance("https://whatsappsimclone-master-default-rtdb.firebaseio.com").getReference().child("user").child(mUser.getUid());
